...
BUILTIN_PACKS = [
    {"slug":"ai","name_zh":"人工智能","name_en":"Artificial Intelligence","description":"结合会议与期刊分级、研究时效和可核验证据，优先呈现近期高质量工作，同时保留值得跟踪的前沿预印本。","sources":["arxiv","semantic_scholar","openalex","crossref"],"categories":["cs.AI","cs.CL","cs.CV","cs.LG","cs.RO"],"keywords":["artificial intelligence","machine learning","agent","multimodal"],"venues":[{"name":"NeurIPS","aliases":["NIPS"],"paper_types":["conference"],"level":"CCF-A/top"},{"name":"ICML","aliases":[],"paper_types":["conference"],"level":"CCF-A/top"},{"name":"ICLR","aliases":[],"paper_types":["conference"],"level":"CCF-A/top"}]},
