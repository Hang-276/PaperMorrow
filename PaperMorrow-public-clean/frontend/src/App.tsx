...
const dailyDomains=[['ai','人工智能','AI 保持最高优先级'],['computer','计算机科学','系统、软件与计算基础'],['physics','物理学','理论、实验与交叉物理'],['math','数学','纯数、应用与统计'],['life-sciences','生命科学','分子、细胞与生物信息'],['clinical-medicine','临床医学','循证研究与临床试验'],['chemistry-materials','化学与材料','化学、催化与材料'],['economics-finance','经济学与金融','经济、计量与金融']] as const
