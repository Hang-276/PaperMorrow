...
<p align="center">
  ...
  <a href="../../releases/tag/v0.5.2">v0.5.2 Beta</a> ·
...
|---|---|---|
| macOS 12+ | [DMG](../../releases/download/v0.5.2/PaperMorrow-macOS.dmg) | Apple silicon; Apple notarization is not complete |
| Windows 10/11 x64 | [Installer](../../releases/download/v0.5.2/PaperMorrow-Windows-Setup.exe) | Standard installer |
| Windows 10/11 x64 | [Portable ZIP](../../releases/download/v0.5.2/PaperMorrow-Windows-Portable.zip) | Extract and run |
