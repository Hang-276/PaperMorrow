...
| 平台 | 下载 | 说明 |
|---|---|---|
| macOS 12+ | [下载 DMG](../../releases/download/v0.5.3/PaperMorrow-macOS.dmg) | Apple silicon；尚未完成 Apple 公证 |
| Windows 10/11 x64 | [下载安装版](../../releases/download/v0.5.3/PaperMorrow-Windows-Setup.exe) | 常规安装版 |
| Windows 10/11 x64 | [下载便携版](../../releases/download/v0.5.3/PaperMorrow-Windows-Portable.zip) | 解压后直接运行 |
